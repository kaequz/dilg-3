...
<hr style="border-top: 1px solid black; width: 30%; margin-left: 530px;">
        <p style="text-align: right; margin-left: 500px; margin-right: auto;"> Lupon Secretary</p>


<br><p style="text-align: justify; margin-top: 0;">
       ATTESTED:</p>
<br>
<br>
       <br>
       <hr style="border-top: 1px solid black; width: 30%; margin-right: 560px;"> 
        <p style="text-align: left; margin-right: 560px; margin-right: auto;">Lupon Chairman</p>
        </p>
        <br>
<br>
<br>
