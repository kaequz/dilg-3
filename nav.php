    ...
    <div class="container d-flex align-items-center justify-content-center">
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li><a class="nav-link scrollto active" href="Barangay Official Directory.html">Barangay Official Directory</a></li>
          <li><a class="nav-link" href="#team">Organizational Structure</a></li>
          <li><a class="nav-link" href="#portfolio">LGU Code</a></li>
          <li><a class="nav-link" href="DILG Intranet.html">DILG Intranet</a></li>
